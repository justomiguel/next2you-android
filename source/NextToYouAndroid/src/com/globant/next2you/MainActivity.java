...
import com.globant.next2you.fragments.FragmentMain;
 ...
 * within the drawer should fall into one of two categories:</p>
 * <p/>
 * <ul>
...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		screensTitles = getResources().getStringArray(R.array.screens_array);
	...
	/**
	 * Do all the stuf required for the NavigationDrawer to show
	 */
	private void initNavDrawer() {
		...
		mDrawerList.setAdapter(new ArrayAdapter<String>(this,
				R.layout.drawer_list_item, screensTitles));
...
//			}
	...
	private void selectNavDrawerItem(int position) {
		...
		case 0:
			...
			args = new Bundle();
			args.putInt(FragmentMain.ARG_SCREEN_NUMBER, position);
		...
		setTitle(screensTitles[position]);
